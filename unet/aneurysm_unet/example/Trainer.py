        ...
        with tf.Session() as sess:
            ...
            for epoch in range(self.epoch_num):
                ...
                for idx in range(val_step):
                    ...
                    # 모델에 데이터를 넣어 줄 Feed Dict입니다.
                    val_feed_dict = {self.model.X: self.valX, self.model.Y: self.valY, self.model.training: False,
                ...
                with open(
                        "/mnt/sdb/bjh/tr_result/dice_lr0.005_decay2500_dr0.9_batch28_rc32_prelu_original/model/train_result_epoch" + str(
