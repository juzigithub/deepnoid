...
class Config(object):
    ...
    NAME = 'Brain Aneurysm'  # Override in sub-classes
    ...
    # Image mean (RGB)
    # TODO ??? RGB 값 평준화로 추측, Image Mold에 사용되며 사용 후 범위가 0~255에서 -123.7~150.1로 변함
    ...
    # # Linux #
    # MODE = 'linux'
    # DATA_PATH = '/home/yuronir/work/data'
    ...
    # Window #
    MODE = 'window'
    DATA_PATH = 'C:\\Users\\YEL\\Documents\\LYE\\workspace\\data\\cerebral_aneurysm\\Brain_Aneurysm_new_dataset'
