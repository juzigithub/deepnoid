...
def save_resized_dcm_as_npy(data_path, save_path, filename):
    ...
    if cfg.REBUILD_HM_DATA :
        ...
        print('total_hm_std_arr_before', total_hm_std_arr)
        ...
        total_hm_std_arr /= n
        print('total_hm_std_arr', total_hm_std_arr.astype(int))
...
def save_val_resized_dcm_as_npy(data_path, save_path, filename):
    ...
    if cfg.REBUILD_HM_DATA :
        ...
        np.save(save_path + 'val_std_landmark.npy', total_hm_std_arr.astype(int))
        print('landmark_saved')
