import aneurysm_detection.cifar10_pretrain.cifar10_pickle as cifar10
...
import aneurysm_detection.cifar10_pretrain.performance_eval as pe
from aneurysm_detection.cifar10_pretrain.model import Model        # choose model
...
class Train:
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            saver = tf.train.Saver(max_to_keep=50, var_list=tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='model'))
            ...
            for epoch in range(cfg.EPOCHS):
                ...
                for batch in tl.iterate.minibatches(inputs=val_X, targets=val_Y,
                    ...
                    loss, acc= sess.run([self.model.loss, self.model.accuracy], feed_dict=val_feed_dict)
