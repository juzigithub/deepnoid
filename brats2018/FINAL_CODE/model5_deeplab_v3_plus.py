...
### Deeplab v3 plus based BeVEAM_NET with generalized dice loss and simple upsampling ###
# 2 downsampling( (192, 192) -> (96, 96) -> (48, 48) ) + 2 atrous conv + 1 ASPP + 1 upsampling( (48, 48) -> (192, 192) )
