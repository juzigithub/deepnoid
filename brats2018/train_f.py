            ...
            for epoch in range(cfg.EPOCHS):
                ...
                for idx, val_idx in enumerate(val_order):
                    ...
                    if cfg.MULTI_VIEW_MODE == 'axial':
                        ...
                        train_X = np.concatenate([X[i][eval('nonzero_idx_{}'.format(i))] for i in train_idx], axis=0)
                        train_Y = np.concatenate([Y[i][eval('nonzero_idx_{}'.format(i))] for i in train_idx], axis=0)
